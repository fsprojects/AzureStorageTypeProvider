...
//    TwoPart.Containers.CloudBlobClient.GetContainerReference("tptest").Exists() =? true
//
//[<Fact>]
//let ``FullPath connection string works``() =
//    FullPath.Containers.CloudBlobClient.GetContainerReference("tptest").Exists() =? true
//
