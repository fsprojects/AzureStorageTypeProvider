...
let getTableStorageMembers schemaInferenceRowCount humanize (connectionString, domainType : ProvidedTypeDefinition) =
    ...
    let createTableType connectionString tableName propertyName = 
        ...
        TableEntityMemberFactory.buildTableEntityMembers schemaInferenceRowCount humanize (tableType, tableEntityType, domainType, connectionString, tableName)
