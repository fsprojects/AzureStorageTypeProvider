...
type BlobFile internal (defaultConnectionString, container, file, getBlobRef : _ -> ICloudBlob) =
    ...
    member this.Download(path:string, connectionString:string option) = 
...
type BlobContainer internal (defaultConnectionString, container) =
    ...
    member __.Download(path:string, connectionString:string option) = 
    ...
    member __.Upload(path:string, connectionString:string option) = 
